...
<h3 align="center">Computer Engineering Student · Backend Developer · AI/ML & Cybersecurity Enthusiast</h3>
...
I'm a final-year **Computer Engineering student** who enjoys building practical software and AI-powered systems.

- 💻 **Focus:** Backend development, AI/ML, computer vision and cybersecurity
- 🔍 **Interests:** Digital forensics, threat intelligence, AI agents and LLM applications
- 🚀 **How I learn:** by building real-world projects and experimenting with new technologies
- 💬 **Ask me about:** Python, FastAPI, Flask, REST APIs, AI/ML, computer vision, React and cybersecurity
...
| :-- | :-- | :-- |
| 🔎 **[MAYA — Media Authenticity Analyzer](https://github.com/vaibhavi1512/AI-Proof-Analyzer)** | Detects potentially manipulated images and videos, with explainable AI, evidence integrity checks and forensic reporting | Python · Flask · EfficientNet · OpenCV · Grad-CAM · SQLite |
| 🕵️ **[Citadel — Dark Web Threat Intelligence](https://github.com/vaibhavi1512/citadel-threat-intel)** | Collects, normalizes and analyzes data from multiple intelligence sources to surface potential organizational threats | Python · Telethon · PRAW · NLP |
...
| **Tools** | ![Postman](https://img.shields.io/badge/Postman-FF6C37?style=flat-square&logo=postman&logoColor=white) ![VS Code](https://img.shields.io/badge/VS%20Code-007ACC?style=flat-square) ![Jupyter](https://img.shields.io/badge/Jupyter-F37626?style=flat-square&logo=jupyter&logoColor=white) ![Power BI](https://img.shields.io/badge/Power%20BI-F2C811?style=flat-square&logoColor=black) ![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white) |
| **Security & Forensics** | Threat Intelligence · OSINT · Digital Forensics · Evidence Integrity (SHA-256) · Chain of Custody · Media Forensics · Deepfake Detection |

---

## 🌱 Currently Learning

**Advanced FastAPI · PostgreSQL · Redis · Docker · System Design · AI Agents · LLM Applications · Cloud & Application Security**
...
<p align="center"><i>I learn by building things that are probably too ambitious 😄</i></p>

<h3 align="center">Build · Learn · Experiment · Improve 🚀</h3>
